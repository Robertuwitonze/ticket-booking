    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 bg-dark" data-aos="zoom-in" style="color: white">
        ...
        if (isset($_POST['add'])) {
          ...
          $query1 = "INSERT INTO route(journey_origin, journey_destination ,price)
            VALUES('$journey_origin','$journey_destination','$price')";
          $query_run = mysqli_query($connection, $query1);
          if ($query_run) {
            echo '<div role="alert">
                <strong>Success!</strong> Route Added Successfully.
            ...
            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Error!</strong> Check your inputs, route was not added.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>';
        ...
        <form action="" method="POST">
          <div class="form-row">
            <div class="col-md-3 mb-3">
              <label>journey_origin</label>
              <input type="text" class="form-control" placeholder="Muhanga" name="journey_origin" required>
            </div>
            <div class="col-md-3 mb-3">
              <label>Journey_destination</label>
              <input type="text" class="form-control" placeholder="Kigali" name="journey_destination" required>
            </div>
            <div class="col-md-3 mb-3">
              <label>Price</label>
        ...
        <div class="table-responsive">
          <table class="table table-hover table-striped table-sm" style="color: white;font-size: 17px;margin-top: 30px;">
            <thead>
              <tr>
                <th>No#</th>
                <th>Journey_origin</th>
                <th>Journey_destination</th>
                <th>Price</th>
            ...
            <tbody>
              <?php
              $count = 0;
              $query = mysqli_query($connection, "SELECT * FROM route");
