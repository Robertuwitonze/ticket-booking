...
if (isset($_POST['add'])) {
  ...
  echo"<script> window.open('journey.php','_self')</script>";
...
<html lang="en">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Virunga Bus Transports</a>
...
<div class="container-fluid">
  <div class="row">
    ...
    <center>
      <div class="footer">
        copy &copy; 2023 Virunga Express ltd
      </div>
    </center>
    </main>
  </div>
