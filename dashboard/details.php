        ...
        <div class='row'>
            <div class='col-md-3'>
                <div class='contact-info'>
                    ...
                    <h2>Bus View Form</h2>
                    <h4>Here you can view the data of any Virunga Bus of your choosing.</h4>
                </div>
            </div>
            <div class='col-md-9'>
                <div class='contact-form'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='lplate' value='$lplate' placeholder='Enter License Plate' name='lplate' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='busmake'>Bus Brand:</label>
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='busmake' value='$busmake' placeholder='Enter Bus Brand' name='busmake' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='busmodel'>Bus Model:</label>
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='busmodel' value='$busmodel' placeholder='Enter Bus Model' name='busmodel' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='driver'>Driver:</label>
                    <div class='col-sm-10'>
                    <select name='driver' disabled>";
                    ...
                    for ($sizeTemp; $sizeTemp >=0; $sizeTemp--){
                        echo "<option value='$arrayId[$sizeTemp]'>$arrayFn[$sizeTemp] $arrayLn[$sizeTemp] (ID $arrayId[$sizeTemp])</option>";
                    }
                    ...
                    <div class='col-sm-10'>
                        <select name='busstatus' disabled>
                    ...
                    <div class='col-sm-offset-2 col-sm-10'>
                        <button type='submit' class='btn btn-danger' name='cancelBus'>Back</button>
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class='row'>
            <div class='col-md-3'>
                <div class='contact-info'>
                    ...
                    <h2>Journey View Form</h2>
                    <h4>Here you can view the data of any Virunga Journey of your choosing.</h4>
                </div>
            </div>
            <div class='col-md-9'>
                <div class='contact-form'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='origin' value='$origin' placeholder='Origin City' name='origin' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='destination'>Destination:</label>
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='destination' value='$destination' placeholder='Destination' name='destination' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    ...
                    $connect = new mysqli("localhost","root","","busmanagement",3306);
                    $queryPl = $connect -> query("SELECT `bus_plate_number` FROM `bus`");
                    $queryBr = $connect -> query("SELECT `bus_make` FROM `bus`");
                    $queryMo = $connect -> query("SELECT `bus_model` FROM `bus`");
                    $queryId = $connect -> query("SELECT `bus_id` FROM `bus`");
                    ...
                    for ($sizeTemp; $sizeTemp >=0; $sizeTemp--){
                        echo "<option value='$arrayBr[$sizeTemp] $arrayMo[$sizeTemp], ($arrayPl[$sizeTemp])' ";if($bus_id == $arrayId[$sizeTemp]){echo"selected";} echo">$arrayBr[$sizeTemp] $arrayMo[$sizeTemp], ($arrayPl[$sizeTemp])</option>";
                    }
                    ...
                    <div class='col-sm-10'>
                        <input type='number' class='form-control' id='price' value='$price' placeholder='Price of a Ticket' name='price' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='tickets'>Number of Tickets:</label>
                    <div class='col-sm-10'>
                        <input type='number' class='form-control' id='tickets' value='$tickets' placeholder='Number of Tickets' name='tickets' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='date'>Departure Date:</label>
                    <div class='col-sm-10'>
                        <input type='date' class='form-control' id='date' value='$date' placeholder='Departure Date' name='date' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='time'>Departure Time:</label>
                    <div class='col-sm-10'>
                        <input type='time' class='form-control' id='time' value='$time' placeholder='Departure Time' name='time' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <div class='col-sm-offset-2 col-sm-10'>
                        <button type='submit' class='btn btn-info' name='viewBook'>Booked Tickets</button>
                    </div>
                    <br>
                    <div class='col-sm-offset-2 col-sm-10'>
                        <button type='submit' class='btn btn-danger' name='cancelJourney'>Back</button>
                    </div>
                    </div>
                </div>
            </div>
...
echo "<script>window.location='tables/bookers.php?jid=$jid';</script>";
}
        ...
        <div class='row'>
            <div class='col-md-3'>
                <div class='contact-info'>
                    ...
                    <h2>Driver View Form</h2>
                    <h4>Here you can view the data of any Virunga Driver of your choosing.</h4>
                </div>
            </div>
            <div class='col-md-9'>
                <div class='contact-form'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='fname' value='$fname' placeholder='Enter First Name' name='fname' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='lname'>Last Name:</label>
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='lname' value='$lname' placeholder='Last Name' name='lname' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='dob'>Date of Birth:</label>
                    <div class='col-sm-10'>
                        <input type='date' class='form-control' id='dob' value='$dob' placeholder='Date of Birth' name='dob' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='driver'>Bus:</label>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='tel' value='$tel' placeholder='Telephone' name='tel' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='email'>Email:</label>
                    <div class='col-sm-10'>
                        <input type='email' class='form-control' id='email' value='$email' placeholder='Email' name='email' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='salary'>Salary:</label>
                    <div class='col-sm-10'>
                        <input type='number' class='form-control' id='salary' value='$salary' placeholder='Salary' name='salary' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <div class='col-sm-offset-2 col-sm-10'>
                        <button type='submit' class='btn btn-danger' name='cancelDriver'>Back</button>
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class='row'>
            ...
            <div class='col-md-9'>
                <div class='contact-form'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='country' value='$country' placeholder='Country' name='country' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    ...
                    <div class='col-sm-10'>
                        <input type='text' class='form-control' id='phone' value='$phone' placeholder='Telephone' name='phone' disabled>
                    </div>
                    </div>
                    <div class='form-group'>
                    <label class='control-label col-sm-2' for='email'>Email:</label>
                    ...
                    <div class='form-group'>
                    <div class='col-sm-offset-2 col-sm-10'>
                        <button type='submit' class='btn btn-danger' name='cancelCustomer'>Back</button>
                    </div>
                    </div>
                </div>
            </div>
